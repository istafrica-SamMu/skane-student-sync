...
interface SystemUsersViewManagementProps {
  views: SavedView[];
...
export const SystemUsersViewManagement = ({
  views,
  currentView,
  onSaveView,
  onLoadView,
  ...
  onColumnsChange,
  onFiltersChange,
}: SystemUsersViewManagementProps) => {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure views and filters for system user data
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <Dialog open={showColumnDialog} onOpenChange={setShowColumnDialog}>
        <DialogContent className="bg-white border border-gray-200 shadow-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Choose which columns to display in the system users table.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
      ...
      <Dialog open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        <DialogContent className="max-w-2xl bg-white border border-gray-200 shadow-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Add and remove filters to customize the system users view.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            {/* Current Filters */}
