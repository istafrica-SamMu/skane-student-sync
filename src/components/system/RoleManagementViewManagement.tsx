...
interface RoleManagementViewManagementProps {
  views: SavedView[];
...
export const RoleManagementViewManagement = ({
  views,
  currentView,
  onSaveView,
  onLoadView,
  ...
  onColumnsChange,
  onFiltersChange,
}: RoleManagementViewManagementProps) => {
      ...
      <CardHeader>
        <CardTitle className="flex items-center justify-between text-ike-neutral-dark">
          <div className="flex items-center">
            ...
            Role Management View Configuration
          </div>
        ...
        <CardDescription>
          Configure views and filters for role management data
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <Dialog open={showColumnDialog} onOpenChange={setShowColumnDialog}>
        <DialogContent className="bg-white border border-gray-200 shadow-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Choose which columns to display in the role management table.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
      ...
      <Dialog open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        <DialogContent className="max-w-2xl bg-white border border-gray-200 shadow-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Add and remove filters to customize the role management view.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            {/* Current Filters */}
