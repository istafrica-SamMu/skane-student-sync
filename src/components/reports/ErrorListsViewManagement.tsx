...
interface ErrorListsViewManagementProps {
  views: SavedView[];
...
export const ErrorListsViewManagement = ({
  views,
  currentView,
  onSaveView,
  onLoadView,
  ...
  const availableFields = [
    ...
    { key: 'personalId', label: 'Personal ID' },
    { key: 'detectedDate', label: 'Detected Date' }
  ];
      ...
      <CardHeader>
        <CardTitle className="flex items-center justify-between text-ike-neutral-dark">
          <div className="flex items-center">
            ...
            Error Lists View Configuration
          </div>
        ...
        <CardDescription>
          Configure views and filters for error lists data
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <Dialog open={showColumnDialog} onOpenChange={setShowColumnDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Choose which columns to display in the error lists table.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
      ...
      <Dialog open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Add and remove filters to customize the error lists view.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            {/* Current Filters */}
