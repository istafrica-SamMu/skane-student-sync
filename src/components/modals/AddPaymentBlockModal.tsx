...
import type { PaymentBlockFormData } from "@/types/paymentBlocks";

interface AddPaymentBlockModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: PaymentBlockFormData) => void;
}

const AddPaymentBlockModal = ({ isOpen, onClose, onSubmit }: AddPaymentBlockModalProps) => {
...
export default AddPaymentBlockModal;
