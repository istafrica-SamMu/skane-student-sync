...
import type { AccountingStringFormData } from "@/types/accounting";

interface AddAccountingStringModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: AccountingStringFormData) => void;
}

const AddAccountingStringModal = ({ isOpen, onClose, onSubmit }: AddAccountingStringModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-ike-neutral-dark">Add Accounting String</DialogTitle>
          <DialogDescription>
            Create a new accounting configuration for a counterparty and price code group.
          </DialogDescription>
        </DialogHeader>
...
export default AddAccountingStringModal;
