...
interface StudentPlacementsViewManagementProps {
  views: SavedView[];
...
export const StudentPlacementsViewManagement = ({
  views,
  currentView,
  onSaveView,
  onLoadView,
  ...
  onColumnsChange,
  onFiltersChange,
}: StudentPlacementsViewManagementProps) => {
  ...
  const availableFields = [
    ...
    { key: 'currentMunicipality', label: 'Current Municipality' },
    { key: 'targetMunicipality', label: 'Target Municipality' },
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Manage custom views and filters for student placements
        </CardDescription>
      </CardHeader>
      <CardContent>
