...
interface TravelCardDocumentsViewManagementProps {
  views: SavedView[];
...
export const TravelCardDocumentsViewManagement = ({
  views,
  currentView,
  onSaveView,
  onLoadView,
  ...
  onColumnsChange,
  onFiltersChange,
}: TravelCardDocumentsViewManagementProps) => {
      ...
      <CardHeader>
        <CardTitle className="flex items-center justify-between text-ike-neutral-dark">
          <div className="flex items-center">
            ...
            Travel Card Documents View Management
          </div>
        ...
        <CardDescription>
          Configure views and filters for travel card documents data
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <Dialog open={showColumnDialog} onOpenChange={setShowColumnDialog}>
        <DialogContent className="bg-white border border-gray-200 shadow-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Choose which columns to display in the travel card documents table.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
      ...
      <Dialog open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        <DialogContent className="max-w-2xl bg-white border border-gray-200 shadow-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Add and remove filters to customize the travel card documents data view.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            {/* Current Filters */}
