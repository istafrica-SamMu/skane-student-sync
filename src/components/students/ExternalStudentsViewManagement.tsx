...
interface ExternalStudentsViewManagementProps {
  views: SavedView[];
...
export const ExternalStudentsViewManagement = ({
  views,
  currentView,
  onSaveView,
  onLoadView,
  ...
  onColumnsChange,
  onFiltersChange,
}: ExternalStudentsViewManagementProps) => {
  ...
  const availableFields = [
    ...
    { key: 'residenceMunicipality', label: 'Residence Municipality' },
    { key: 'schoolMunicipality', label: 'School Municipality' },
    { key: 'school', label: 'School' },
    { key: 'program', label: 'Program' },
    { key: 'class', label: 'Class' },
    { key: 'status', label: 'Status' },
    { key: 'ikeCost', label: 'IKE Cost' },
      ...
      <CardHeader>
        <CardTitle className="flex items-center justify-between text-ike-neutral-dark">
          <div className="flex items-center">
            ...
            External Students View Management
          </div>
        ...
        <CardDescription>
          Configure views and filters for external students data
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <Dialog open={showColumnDialog} onOpenChange={setShowColumnDialog}>
        <DialogContent className="bg-white border border-gray-200 shadow-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Choose which columns to display in the external students table.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
      ...
      <Dialog open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        <DialogContent className="max-w-2xl bg-white border border-gray-200 shadow-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Add and remove filters to customize the external students data view.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            {/* Current Filters */}
