...
import { Save, Eye, Columns, Filter, Trash2 } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';

interface AdditionalAmountsViewManagementProps {
  views: SavedView[];
...
export const AdditionalAmountsViewManagement: React.FC<AdditionalAmountsViewManagementProps> = ({
  views,
  currentView,
  onSaveView,
  onLoadView,
